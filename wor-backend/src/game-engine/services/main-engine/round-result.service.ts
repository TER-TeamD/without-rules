...
export class RoundResultService {
    ...
    public async generateNextAction(): Promise<Game> {
        ...
        if (currentGame.in_game_property.between_round != null && currentGame.in_game_property.between_round.index_current_player_action_in_player_order === currentGame.in_game_property.between_round.playerOrder.length) {
            ...
            if (currentGame.in_game_property.between_round != null && currentGame.in_game_property.between_round.current_player_action !== null && currentGame.in_game_property.between_round.current_player_action.action.type === "CHOOSE_STACK_CARD") {
            ...
            if (bestStackCardForPuttingCurrentPlayerCard === null) {
                ...
                if (bestStackCardForPuttingCurrentPlayerCard.stackCards.length === (MAX_CARDS_PER_STACK - 1)
                    ...
                    if (currentGame.in_game_property.between_round && currentGame.in_game_property.between_round.current_player_action
