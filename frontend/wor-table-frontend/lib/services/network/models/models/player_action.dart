...
class SendCardToStackCardAndAddCardsToPlayerDiscardPlayerAction extends PlayerAction {
  final int stackNumber;

  SendCardToStackCardAndAddCardsToPlayerDiscardPlayerAction(this.stackNumber) : super(sendCardToStackAndAddCardToPlayerDiscard);
  SendCardToStackCardAndAddCardsToPlayerDiscardPlayerAction.fromJson(Map<String, dynamic> json) :
        this(json['stack_number']);
}
...
class ChooseStackCardPlayerAction extends PlayerAction {
  ...
  ChooseStackCardPlayerAction(this.choosenStackCardByPlayer) : super(chooseCardStack);
...
class NextRoundPlayerAction extends PlayerAction {
  ...
  NextRoundPlayerAction.fromJson(Map<String, dynamic> json) :
        this();
}